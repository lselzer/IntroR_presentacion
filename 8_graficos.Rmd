...
library(animation)
ani.options(autobrowse = FALSE, interval = 0.1, convert = "C:\\Program Files\\ImageMagick-7.0.3-Q16\\convert.exe")
...
```{r, echo=FALSE, fig.show='animate', message=FALSE, results='hide', fig.height=5}
library(gganimate)
library(tweenr)
library(dplyr)
